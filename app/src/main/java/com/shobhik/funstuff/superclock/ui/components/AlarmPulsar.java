 ...
 */
public class AlarmPulsar extends RelativeLayout {
     ...
     *                theme, resources, etc.
     */
    public AlarmPulsar(Context context) {
        this(context, null, 0);
    }
     ...
     */
    public AlarmPulsar(Context context, AttributeSet attrs) {
     ...
     *                     for defaults.
     */
    public AlarmPulsar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            color = attr.getColor(pl.bclogic.pulsator4droid.library.R.styleable.Pulsator4Droid_pulse_color, DEFAULT_COLOR);
        } finally {
            attr.recycle();
        }
